      ...
      <View>
        ...
        <View style={styles.header}>
          <View style={styles.headerPlaceholder}>
            <Icon style={styles.headerPlaceholderIcon} fontFamily="iconfont" 
              source={{uri: data.iconfont, codePoint: '\uE603'}} />
            ...
            return (
              <View style={styles.listItem}>
                ...
                <View style={styles.listItemBottom}>
                  <Text style={styles.listItemBottomText}>827 赞</Text>
                  <View style={styles.listItemBottomPoint} />
                  <Text style={styles.listItemBottomText}>110 评论</Text>
                  <View style={styles.listItemBottomPoint} />
                  <Text style={styles.listItemBottomText}>去往文章列表</Text>
                </View>
              </View>
            )
          }}
        ...
        <View style={styles.bottomBar}>
          <MultiRow
            ...
            renderCell={(item, index) => {
              let colorStyle = {};
              if (index == 0) { colorStyle.color = '#008bff'; }
              return (
